cask "battsafe" do
  version "2.0.2"
  sha256 "33dd1b9a94a688b72160acdf0240f54656789d1853965c0154a644f801317bdb"

  url "https://github.com/zerry-lab/battsafe-releases/releases/download/v2.0.2/BattSafe.zip"
  name "BattSafe"
