cask "battsafe" do
  version "1.3.8"
  sha256 "5a82248d842b092a9ad4d7793f2e175492aff6db9e976dae55c9458fcf63bfb2"

  url "https://github.com/zerry-lab/battsafe-releases/releases/download/v1.3.8/BattSafe.zip"
  name "BattSafe"
