cask "battsafe" do
  version "1.8.0"
  sha256 "f1b81a7c0f114f0a40a0d0b4e5756a5e9eb320cd84290630e3af2921beea901c"

  url "https://github.com/zerry-lab/battsafe-releases/releases/download/v1.8.0/BattSafe.zip"
  name "BattSafe"
