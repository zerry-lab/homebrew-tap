cask "battsafe" do
  version "1.7.7"
  sha256 "a7ba0b78163c40b9f37978949378066793368402fdc409cc6fd3519c8bb753c8"

  url "https://github.com/zerry-lab/battsafe-releases/releases/download/v1.7.7/BattSafe.zip"
  name "BattSafe"
