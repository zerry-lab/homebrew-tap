cask "battsafe" do
  version "2.0.1"
  sha256 "bdabda39ddaa29163d354b4ee429136259b2682a5b16a773dcf6ea2b35a04fec"

  url "https://github.com/zerry-lab/battsafe-releases/releases/download/v2.0.1/BattSafe.zip"
  name "BattSafe"
