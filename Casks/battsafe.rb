cask "battsafe" do
  version "1.7.1"
  sha256 "57bdc31588ed4a1196d7767ca402764e7d9d8ba5934618587650ab2af83237f7"

  url "https://github.com/zerry-lab/battsafe-releases/releases/download/v1.7.1/BattSafe.zip"
  name "BattSafe"
