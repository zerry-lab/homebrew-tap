cask "battsafe" do
  version "1.8.2"
  sha256 "f46c41daba901064ef87f2bfe8193f89bfe9d0d9cd9b750ec53af637cd1a16e8"

  url "https://github.com/zerry-lab/battsafe-releases/releases/download/v1.8.2/BattSafe.zip"
  name "BattSafe"
